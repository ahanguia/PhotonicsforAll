...
public class LensesNMirrorsUnderstandActivity extends AppCompatActivity {
    String url;
    ...
    public String getUrl() {
        if(DataLoader.getLanguage()=="fr")
            url="file:///android_asset/basicsphotonics/fr/lenses.html";
        else
            url="file:///android_asset/basicsphotonics/en/lenses.html";
        return url;
    }
}
