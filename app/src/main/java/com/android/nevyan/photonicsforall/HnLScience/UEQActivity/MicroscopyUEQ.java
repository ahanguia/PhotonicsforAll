...
import com.android.nevyan.photonicsforall.HnLScience.Microscopy.MicroscopyExperiment;
import com.android.nevyan.photonicsforall.HnLScience.Microscopy.MicroscopyQuiz;
import com.android.nevyan.photonicsforall.HnLScience.Microscopy.MicroscopyUnderstand;
import com.android.nevyan.photonicsforall.R;
import com.android.nevyan.photonicsforall.exprience_tools.Ressource;

public class MicroscopyUEQ extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_microscopy_ueq, menu);
        return true;
    }
    ...
    public void OnCLKQuiz(View view){
        Intent intent = new Intent(this, MicroscopyQuiz.class);
        startActivity(intent);
    }


    public void onCLKexperiment(View view){
        Experience.setExperience(MicroscopyExperiment.class, Ressource.microscopy, R.color.red_l1, view, this);
    }
    public void onCLKunderstand(View view){
        ...
        intent.putExtra("urlFr", UnderstandRessource.FRmicroscopy);
        intent.putExtra("urlEn", UnderstandRessource.ENmicroscopy);
        startActivity(intent);
    }
}
