...
import com.android.nevyan.photonicsforall.PhotonicsForICT.OpticalCommunication.OpticalCommunicationQuiz;
import com.android.nevyan.photonicsforall.PhotonicsForICT.OpticalCommunication.OpticalCommunicationUnderstand;
import com.android.nevyan.photonicsforall.R;
import com.android.nevyan.photonicsforall.exprience_tools.Ressource;

public class OpticalCommunicationUEQActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_optical_communication_ueq, menu);
        return true;
    }
    ...
    public void OnCLKQuiz(View view){
        Intent intent = new Intent(this, OpticalCommunicationQuiz.class);
