...
public class ExploreControleUnderstandActivity extends AppCompatActivity {
    String url;
    ...
    public String getUrl() {
        if(DataLoader.getLanguage()=="fr")
            url="file:///android_asset/basicsphotonics/fr/explore.html";
        else
            url="file:///android_asset/basicsphotonics/en/explore.html";
        return url;
    }
}
