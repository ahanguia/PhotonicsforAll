package com.android.nevyan.photonicsforall.HnLScience.Microscopy;
...
public class MicroscopyExperiment extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_microscopy_experiment, menu);
        return true;
    }
