...
public class LaserConceptUnderstandActivity extends AppCompatActivity {
    String url;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.loadUrl("file:///android_asset/basicsphotonics/laser.html");*/
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_laser_concept_understand, menu);
        return true;
    }
    ...
    public String getUrl() {
        if(DataLoader.getLanguage()=="fr")
            url="file:///android_asset/basicsphotonics/fr/laser.html";
        else
            url="file:///android_asset/basicsphotonics/en/laser.html";
        return url;
    }
}
