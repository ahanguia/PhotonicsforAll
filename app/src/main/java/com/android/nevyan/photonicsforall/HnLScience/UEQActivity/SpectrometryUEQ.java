...
import com.android.nevyan.photonicsforall.HnLScience.Spectrometry.SpectrometryQuiz;
import com.android.nevyan.photonicsforall.HnLScience.Spectrometry.SpectrometryUnderstand;
import com.android.nevyan.photonicsforall.R;
import com.android.nevyan.photonicsforall.exprience_tools.Ressource;

public class SpectrometryUEQ extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_spectrometry_ueq, menu);
        return true;
    }
    ...
    public void OnCLKQuiz(View view){
        Intent intent = new Intent(this, SpectrometryQuiz.class);
