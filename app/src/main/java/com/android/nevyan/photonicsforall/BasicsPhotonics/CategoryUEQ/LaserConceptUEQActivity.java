...
import com.android.nevyan.photonicsforall.BasicsPhotonics.Laser_Concept.LaserConceptExperiment;
...
public class LaserConceptUEQActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_laser_concept_ueq, menu);
        return true;
    }
    ...
    public void OnCLKQuiz(View view){
        Intent intent = new Intent(this, LaserConceptQuizActivity.class);
        startActivity(intent);
    }

    public void onCLKexperiment(View view){
        Experience.setExperience(LaserConceptExperiment.class, Ressource.laserConcept, R.color.blue_l1, view, this);
    }
