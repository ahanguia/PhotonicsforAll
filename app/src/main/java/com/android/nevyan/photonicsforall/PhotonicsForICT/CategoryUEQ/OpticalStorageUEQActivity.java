...
import com.android.nevyan.photonicsforall.PhotonicsForICT.OpticalStorage.OpticalStorageExperiment;
import com.android.nevyan.photonicsforall.PhotonicsForICT.OpticalStorage.OpticalStorageQuiz;
import com.android.nevyan.photonicsforall.PhotonicsForICT.OpticalStorage.OpticalStorageUnderstand;
import com.android.nevyan.photonicsforall.R;
import com.android.nevyan.photonicsforall.exprience_tools.Ressource;

public class OpticalStorageUEQActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_optical_storage_ueq, menu);
        return true;
    }
    ...
    public void OnCLKQuiz(View view){
        Intent intent = new Intent(this, OpticalStorageQuiz.class);
        startActivity(intent);
    }


    public void onCLKexperiment(View view){
        Experience.setExperience(OpticalStorageExperiment.class, Ressource.opticalStorage, R.color.green_l1, view, this);
    ...
    public void onCLKunderstand(View view){
        ...
        intent.putExtra("urlFr", UnderstandRessource.FRopticalStorage);
        intent.putExtra("urlEn", UnderstandRessource.ENopticalStorage);
        startActivity(intent);
    }
}
