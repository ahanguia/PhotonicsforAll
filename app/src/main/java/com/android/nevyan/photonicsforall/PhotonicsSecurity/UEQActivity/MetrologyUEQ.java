...
import com.android.nevyan.photonicsforall.PhotonicsSecurity.Metrology.MetrologyUnderstand;
import com.android.nevyan.photonicsforall.R;
import com.android.nevyan.photonicsforall.exprience_tools.Ressource;

public class MetrologyUEQ extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_metrology_ueq, menu);
        return true;
    }
    ...
    public void OnCLKQuiz(View view){
        Intent intent = new Intent(this, MetrologyQuiz.class);
        startActivity(intent);
    }


    public void onCLKexperiment(View view){
        Intent intent = new Intent(this, MetrologyExperiment.class);
