...
public class LensesNMirrorsUEQActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_lenses_nmirrors_ueq, menu);
        return true;
    }
    ...
    public void OnCLKQuiz(View view){
        Intent intent = new Intent(this, LensesNMirrorsQuizActivity.class);
        startActivity(intent);
    }

    public void onCLKexperiment(View view){
        Experience.setExperience(LensesNMirrorsExperimentActivity.class, Ressource.lensesNMirrors, R.color.blue_l1, view, this);
    }
